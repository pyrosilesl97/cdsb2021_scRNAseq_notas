...
- **¿Alquien me puede explicar que hace el método que estamos usando para reducir la dimensionalidad de los datos?**
...
Obtener el peso que esta en la diagonal, sumar lo que no esta en la diagonal. 
```{r}

diag_sum <- sum(diag(ratio),na.rm = T)
no_diag_sum <- sum(ratio,na.rm = T) - diag_sum
```
